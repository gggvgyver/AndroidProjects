...
class BlackJackActivity : AppCompatActivity() {
    ...
    private fun showDealerCards(){
        ...
        for(c in dealerhand){
            ...
            //set layout
            imageview1.layoutParams.width = 170
    ...
    private fun showvalue(){
        ...
        if (pvalue.value() <= 21) {
            ...
            ptext.text = pvalue.value().toString() + " 버스트"
        }
        ...
        if (dvalue.value() <= 21) {
            ...
            dtext.text = dvalue.value().toString() + " 버스트"
        }
    ...
    fun restartClick(view: View){
        ...
        var rbutton = findViewById<Button>(R.id.btn_restart)
